...
gflags.DEFINE_integer('initial_epoch', 34, 'Initial epoch to start training')

log_folder = 'darknet14_3.7'
# Files
...
gflags.DEFINE_bool('restore_model', True, 'Whether to restore a trained'
                   ' model for training')
gflags.DEFINE_string('weights_fname', "weights_034.h5", '(Relative) '
